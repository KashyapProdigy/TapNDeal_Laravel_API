...
Route::post('user/relation/promote/customer/{id}','API\customerRelationshipController@promote');
Route::post('user/relation/demote/customer/{id}','API\customerRelationshipController@demote');
...
Route::get('user/relation/show/seller/productlist','API\customerRelationshipController@productlist');
...
Route::post('user/relation/promote/agent/{id}','API\agentRelationshipController@promote');
Route::post('user/relation/demote/agent/{id}','API\agentRelationshipController@demote');
