...
class dashboardController extends Controller
{
    public function getdashboard(Request $req, $id)
    {
        ...
        if($loggedInUser->type_id == 2)
        {
            ...
            $seller['A_Plus_Sellers']=User::join('citys','citys.id','users.city_id')->whereIn('users.id',$A_Plus_list)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->get()->toarray();
            $seller['A_Sellers']=User::join('citys','citys.id','city_id')->whereIn('users.id',$A_list)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
            $seller['B_Plus_Sellers']=User::join('citys','citys.id','city_id')->whereIn('users.id',$B_Plus_list)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
            $seller['B_Sellers']=User::join('citys','citys.id','city_id')->whereIn('users.id',$B_list)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
        ...
        if($loggedInUser->type_id == 3)
        {
            ...
            $dashboard['A_Plus_Sellers']=User::join('citys','citys.id','city_id')->whereIn('users.id',$A_Plus_list)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
            $dashboard['A_Sellers']=User::join('citys','citys.id','city_id')->whereIn('users.id',$A_list)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
            $dashboard['B_Plus_Sellers']=User::join('citys','citys.id','city_id')->whereIn('users.id',$B_Plus_list)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
            $dashboard['B_Sellers']=User::join('citys','citys.id','city_id')->whereIn('users.id',$B_list)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
            $dashboard['NotConnected_Sellers']=User::join('citys','citys.id','city_id')->where('type_id',1)->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->where('isVerified',1)->whereNotIN('users.id',$Blocked_seller)->whereNotIN('users.id',$A_Plus_list)->whereNotIN('users.id',$A_list)->whereNotIN('users.id',$B_Plus_list)->whereNotIN('users.id',$B_list)->join('company_info','company_info.sid','users.id','citys.city_name')->orderBy('name')->get()->toarray();
            $dashboard['Agents']=User::where('type_id',2)->where('isVerified',1)->whereNotIN('users.id',$Blocked_Agent)->orderBy('name')->get()->toarray();
            $dashboard['connected_agents']=CustomerAgentRelationship::join('users','users.id','cust_agent_rel.agent_id')->join('citys','citys.id','city_id')->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')
            ->where([['cust_id',$id],['isBlocked',0]])->orderBy('name')->get();
            $dashboard['Not_connected_agents']=User::join('citys','citys.id','city_id')->where('type_id',2)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->where('isVerified',1)->whereNotIn('users.id',$con_ag)->orderBy('name')->get();
            if(!empty($dashboard))
            {
        ...
        if($loggedInUser->type_id==4 || $loggedInUser->type_id==5 || $loggedInUser->type_id==6 || $loggedInUser->type_id==8)
        {
            ...
            if($loggedInUser == null)
            {
              return response()->json(['error' => true ,'message'=>"No User Found"]);
                ...
                $customer['A_Plus_Customers']=User::join('citys','citys.id','city_id')->whereIn('users.id',$A_Plus_Cust_List)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
                $customer['A_Customers']=User::join('citys','citys.id','city_id')->whereIn('users.id',$A_Cust_List)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
                $customer['B_Plus_Customers']=User::join('citys','citys.id','city_id')->whereIn('users.id',$B_Plus_Cust_List)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
                ...
                $customer['NotConnected_Customers']=User::join('citys','citys.id','city_id')->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->where('type_id',3)->where('isVerified',1)->whereNotIN('users.id',$Blocked_Customer)->whereNotIN('users.id',$A_Plus_Cust_List)->whereNotIN('users.id',$A_Cust_List)->whereNotIN('users.id',$B_Plus_Cust_List)->whereNotIN('users.id',$B_Cust_List)->get()->toarray();
                ...
                $agent['A_Plus_Agents']=User::join('citys','citys.id','city_id')->whereIn('users.id',$A_Plus_Agent_List)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
                $agent['A_Agents']=User::join('citys','citys.id','city_id')->whereIn('users.id',$A_Agent_List)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
                $agent['B_Plus_Agents']=User::join('citys','citys.id','city_id')->whereIn('users.id',$B_Plus_Agent_List)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
                $agent['B_Agents']=User::join('citys','citys.id','city_id')->whereIn('users.id',$B_Agent_List)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
                ...
                $agent['NotConnected_agent']=User::join('citys','citys.id','city_id')->where('type_id',2)->where('isVerified',1)
                    ...
                    ->whereNotIN('users.id',$B_Agent_List)->join('company_info','company_info.sid','users.id')->select('users.*','company_info.cname','citys.city_name')->where('isDeleted',0)->orderBy('name')->get()->toarray();
                $dashboard['Customers']=$customer;
